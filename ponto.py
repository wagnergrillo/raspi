...
class PontoGUI(tk.Tk):   
	...
	#self.margin_frame.pack(pady=50)
        ...
        self.update_time()
        self.status_label = tk.Label(self, text="Aproxime o Chachá...", font=("Arial", 20), fg="#F400A1")
...
if __name__ == "__main__":
    ...
    def verificar_conexao_e_enviar_dados():
        ...
        app.after(300000, verificar_conexao_e_enviar_dados)  # Executar aaa cada 5 minutos que sãoo 300000 milissegundos
